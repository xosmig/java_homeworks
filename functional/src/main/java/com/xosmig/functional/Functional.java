...
public final class Functional {
    public static <T, R>
    Lazy<LazyList<R>> map(Function1<T, R> f, Iterable<T> a) {
        return foldr(
    ...
    public static <T>
    Lazy<LazyList<T>> filter(Predicate1<T> p, Iterable<T> a) {
        return foldr(
...
//    }
    ...
    public static <T, R>
    Lazy<R> foldr(Function2<T, Lazy<R>, R> f, R init, Iterable<T> a) {
